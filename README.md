...
* Loading and joining datasets by country
* Exploring data using filtering, sorting, and grouping
...
2. The notebook will open automatically in Google Colab
3. Upload the datasets (CSV files) when prompted
